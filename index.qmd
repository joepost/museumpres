...
-   Infection prevention (IP) nursing team use paper records and Excel to trace contacts
...
-   Time-consuming, error-prone, and poorly documented
...
Needs to be simple to use and intuitive for end-users (non-coders).
